...
#endif
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkGetPhysicalDeviceSurfaceSupportKHR)
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkGetPhysicalDeviceSurfaceCapabilitiesKHR)
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkGetPhysicalDeviceSurfaceFormatsKHR)
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkGetPhysicalDeviceSurfacePresentModesKHR)
...
#ifndef DE_VK_KHR_SWAPCHAIN_FUNCTION
#define DE_VK_KHR_SWAPCHAIN_FUNCTION( function )
#endif
DE_VK_KHR_SWAPCHAIN_FUNCTION(vkCreateSwapchainKHR)
DE_VK_KHR_SWAPCHAIN_FUNCTION(vkGetSwapchainImagesKHR)
DE_VK_KHR_SWAPCHAIN_FUNCTION(vkAcquireNextImageKHR)
DE_VK_KHR_SWAPCHAIN_FUNCTION(vkQueuePresentKHR)
DE_VK_KHR_SWAPCHAIN_FUNCTION(vkDestroySwapchainKHR)
#undef DE_VK_KHR_SWAPCHAIN_FUNCTION